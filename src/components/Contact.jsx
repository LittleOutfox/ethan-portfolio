      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        >
          <a
            ...
            className="tap-target font-display italic font-medium text-[clamp(24px,4vw,46px)] text-ink no-underline border-b border-ink/30 pb-1.5 transition-colors hover:border-seal focus-visible:border-seal"
          >
            {CONTACT_EMAIL}
          </a>
        ...
        >
          <div className="text-right font-mono text-[10.5px] tracking-[0.2em] uppercase leading-[1.7] text-ink/60">
            <div>Maker&rsquo;s mark</div>
            <div className="text-ink/55">九尾 · nine tails</div>
          </div>
